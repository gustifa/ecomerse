<div class="dashboard_sidebar">
        ...
        <a href="{{route('vendor.dashboard')}}" class="dash_logo"><img src="images/logo.png" alt="logo" class="img-fluid"></a>
        <ul class="dashboard_link">
          <li><a class="active" href="{{route('vendor.dashboard')}}"><i class="fas fa-tachometer"></i>Dashboard</a></li>
          <li><a href="{{route('vendor.shop-profile.index')}}"><i class="fas fa-list-ul"></i> Shop Profile</a></li>
