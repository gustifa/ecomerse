                      ...
                      <div class="row">
                        <div class="col-xl-6 col-md-6">
                          <div class="wsus__dash_pro_single">
                            ...
                            <input type="text" placeholder="First Name" value="{{$vendorProfile->name}}">
                          </div>
                        </div>
                        <div class="col-xl-6 col-md-6">
                          <div class="wsus__dash_pro_single">
                        ...
                        <div class="col-xl-6 col-md-6">
                          <div class="wsus__dash_pro_single">
                            ...
                            <input type="text" placeholder="Phone" value="{{$vendorProfile->phone}}">
                          </div>
                        </div>
                        <div class="col-xl-6 col-md-6">
                          <div class="wsus__dash_pro_single">
                            <i class="fal fa-envelope-open"></i>
                            <input type="email" placeholder="Email" value="{{$vendorProfile->email}}">
                          </div>
                        </div>
                        <div class="col-xl-12">
                          <div class="wsus__dash_pro_single">
